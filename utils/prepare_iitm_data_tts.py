...
def save_txts_from_txt_done_data(text_path, wav_path_for_annotations_txt, out_path_for_txts, num_samples_valid, num_samples_test):
    ...
    for f, t in zip(fnames, ftexts):
        print(os.path.join(wav_path_for_annotations_txt, f)+'.wav', t, sep='|', file=outfile_f)
    ...
    save_train_test_valid_split(annotations_txt=outfile, num_samples_valid=num_samples_valid, num_samples_test=num_samples_test)
...
if __name__ == '__main__':
    ...
    save_txts_from_txt_done_data(text_path, wav_path_for_annotations_txt, out_path_for_txts,
                                num_samples_valid, num_samples_test)
